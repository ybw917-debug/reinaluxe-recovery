...
def build_research_plan(request: ResearchRequest) -> ResearchPlan:
    ...
    base = {
        ...
        "maximum_discovery_rounds": hashed_request.maximum_discovery_rounds,
        "first_round_call_budget": hashed_request.first_round_call_budget,
        "second_round_call_budget": hashed_request.second_round_call_budget,
        "total_call_budget": hashed_request.total_call_budget,
